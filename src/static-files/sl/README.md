...
- `cookies.html`: Information about cookies (unchanged from V5).
...
- `license-templateXXXX-versionXX.html`: Template for forming new licence texts. Not translated.
- `licence-aca-id-by-inf-nored-1.0.html`: CLARIN.SI licence texts (CLARIN.SI only, not part of LINDAT DSpace). Not translated.
- `licence-aca-id-by-nc-inf-nored-1.0.html`: CLARIN.SI licence texts (CLARIN.SI only, not part of LINDAT DSpace). Not translated.
