...
|------|---------------|------------------|-------|
| `about.html` | YES | YES | English changed from v5 |
| `cite.html` | YES | YES | English changed from v5 |
| `cookies.html` | YES | YES | English changed from v5 |
| `deposit.html` | YES | YES | English changed from v5 |
